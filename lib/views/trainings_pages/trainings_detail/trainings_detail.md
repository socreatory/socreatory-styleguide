...
<main class="container container--xl container-vertical-spacing-xl">
    <div class="layout-main-with-sidebar">
        ...
        <div id="booking" class="layout-main-with-sidebar__sidebar">
            ...
            <pretix-widget event="https://pretix.eu/socreatory/foundation--praesenz/" style="list,"></pretix-widget>
            <a href="https://pretix.eu/socreatory/" class="link-attribution" target="_blank">Event-Ticketing-Software von pretix</a>
            <h3 class="m-t-lg">Inhouse Schulung</h3>
