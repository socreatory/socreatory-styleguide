...
<main>
    ...
    <section class="container container--xl container-vertical-spacing-xl">
        <h2 class="section__title--small"><span aria-hidden>-- </span>Trainer:innen Übersicht</h2>
        <ul class="profiles">
            <li class="profile">
            ...
            <li class="profile">
                ...
                <p class="profile__focus">Flexible Architekturen</p>
            </li>
            <li class="profile">
            ...
            <li class="profile">
                ...
                <p class="profile__focus">Web Security</p>
            </li>
            <li class="profile">
                ...
                <p class="profile__focus">Software Analytics</p>
            </li>
            <li class="profile">
                ...
                <p class="profile__focus">Flexible Architekturen & Java</p>
            </li>
            <li class="profile">
                ...
                <p class="profile__focus">Fokus</p>
            </li>
            <li class="profile">
            ...
            <li class="profile">
                ...
                <h3 class="profile__name"><a href="#" class="profile__link">Markus Harrer</a></h3>
                <p class="profile__focus">Fokus</p>
            </li>
            <li class="profile">
            ...
            <li class="profile">
                ...
                <h3 class="profile__name"><a href="#" class="profile__link">Niko Will</a></h3>
                <p class="profile__focus">Fokus</p>
            </li>
            <li class="profile">
            ...
            <li class="profile">
                ...
                <h3 class="profile__name"><a href="#" class="profile__link">Stefan Bodewig</a></h3>
                <p class="profile__focus">Fokus</p>
            </li>
            <li class="profile">
            ...
            <li class="profile">
                ...
                <h3 class="profile__name"><a href="#" class="profile__link">Sven Johann</a></h3>
                <p class="profile__focus">Fokus</p>
            </li>
            <li class="profile">
